...
RSpec.describe Contact, type: :model do # rubocop:disable Metrics/BlockLength
  ...
  context 'Methods' do
    it 'finds by users' do
      ...
      expect(Contact.find_by_users(user1.id, user2.id)).to eq contact # rubocop:disable Rails/DynamicFindBy
    end
  end
end
